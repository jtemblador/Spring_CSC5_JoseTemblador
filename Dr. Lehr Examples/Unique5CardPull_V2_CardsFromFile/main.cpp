...
int main(int argc, char** argv) {
    ...
    //Display Outputs
    cout<<setw(14)<<card1<<setw(3)<<vC1<<endl
        <<setw(14)<<card2<<setw(3)<<vC2<<endl
        <<setw(14)<<card3<<setw(3)<<vC3<<endl
        <<setw(14)<<card4<<setw(3)<<vC4<<endl
        <<setw(14)<<card5<<setw(3)<<vC5<<endl;
